...
export default function Home() {
  ...
  const data: CVData = (cvData as CVDataCollection)[language];
  const t: Translations = (translations as TranslationsCollection)[language];
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <section className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ul className="space-y-2">
                {data.competencias_pessoais.map(
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2h2zm4-3a1 1 0 00-1 1v1h2V4a1 1 0 00-1-1zM4 9v5h12V9H4z"
                    clipRule="evenodd"
                  />
                </svg>
              ...
              <div className="space-y-6">
                {data.experiencia_profissional.map(
                  (exp: Experience, index: number) => (
                    ...
                    >
                      ...
                      <h5 className="text-indigo-600 font-medium">
                        {exp.empresa}
                      </h5>
            ...
            <section className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                {data.formacao_academica.map(
                  (formacao: Education, index: number) => (
                    <div
                      key={index}
